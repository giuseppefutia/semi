...
/**
 *
 * Run JARQL command to create RDF data from the JARQL-serialized of plausible semantic models.
 *
 * RDF data will be adopted in the refinement process
 *
 * TODO: RDF from JARQL-serialized of semantic model obtained with steiner tree currently is not necessary
 *
 */
...
var jarql_folder = 'data/taheriyan2016/' + data_folder + '/semantic_models/plausibles/jarql/';
var jarql_output_folder = 'data/taheriyan2016/' + data_folder + '/semantic_models/plausibles/rdf/';
