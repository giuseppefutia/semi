...
# Test on the refined steiner tree
node run/steiner_tree.js \
data/taheriyan2016/task_04/semantic_types/updated/armslist_st.json \
data/taheriyan2016/task_04/refined_semantic_models/plausibles/graph/armslist_graph.json \
data/taheriyan2016/task_04/refined_semantic_models/steiner/graph/armslist \
