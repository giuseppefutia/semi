var fs = require('fs');
var jarql = require(__dirname + '/../src/semantic_modeling/jarql_st.js');
...
var run = () => {
    ...
    fs.writeFileSync(sm_path + '_st.query', jarql_to_print);
    console.log('The JARQL file is written in: ' + sm_path + '_st.query');
}
